...
/** @type {string} */
const CACHE_VERSION = '1776797753|1074366358';
/** @type {string} */
const CACHE_PREFIX = 'Turtle-game-sw-cache-';
const CACHE_NAME = CACHE_PREFIX + CACHE_VERSION;
/** @type {string} */
const OFFLINE_URL = 'Turtle-game.offline.html';
/** @type {boolean} */
const ENSURE_CROSSORIGIN_ISOLATION_HEADERS = true;
// Files that will be cached on load.
/** @type {string[]} */
const CACHED_FILES = ["Turtle-game.html","Turtle-game.js","Turtle-game.offline.html","Turtle-game.icon.png","Turtle-game.apple-touch-icon.png","Turtle-game.audio.worklet.js","Turtle-game.audio.position.worklet.js"];
// Files that we might not want the user to preload, and will only be cached on first load.
/** @type {string[]} */
const CACHEABLE_FILES = ["Turtle-game.wasm","Turtle-game.pck"];
